import { Product, Category, StoreSettings } from '../src/types.js';
...
export const INITIAL_SETTINGS: StoreSettings = {
  ...
  freeDeliveryThreshold: 0, // Free Home Delivery across Bangladesh as specified
...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  {
    id: 'prod-8',
    name: 'Relaxed Fit Linen Blend Summer Shirt',
    ...
    shortDescription: 'Airy linen-cotton blend shirt with relaxed Cuban collar.',
    category: 'Shirts',
    categorySlug: 'shirts',
    ...
    colors: ['Sand Beige', 'Natural White', 'Dusty Olive'],
    sizes: ['M', 'L', 'XL'],
    material: '55% French Linen, 45% Organic Cotton (145 GSM)',
    features: [
      'High breathability rating for humid weather',
      'Real coconut shell buttons',
      'Straight hem looks great untucked'
    ],
